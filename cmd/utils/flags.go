...
import (
	...
	"github.com/novaknole/go-ethereum/common/fdlimit"
	"github.com/novaknole/go-ethereum/consensus"
	"github.com/novaknole/go-ethereum/consensus/clique"
	...
	"github.com/novaknole/go-ethereum/eth/downloader"
	"github.com/novaknole/go-ethereum/eth/gasprice"
	"github.com/novaknole/go-ethereum/ethdb"
	"github.com/novaknole/go-ethereum/ethstats"
	"github.com/novaknole/go-ethereum/graphql"
	"github.com/novaknole/go-ethereum/internal/ethapi"
	"github.com/novaknole/go-ethereum/internal/flags"
	"github.com/novaknole/go-ethereum/les"
	"github.com/novaknole/go-ethereum/log"
	"github.com/novaknole/go-ethereum/metrics"
	"github.com/novaknole/go-ethereum/metrics/exp"
	"github.com/novaknole/go-ethereum/metrics/influxdb"
	"github.com/novaknole/go-ethereum/miner"
	"github.com/novaknole/go-ethereum/node"
	"github.com/novaknole/go-ethereum/p2p"
	"github.com/novaknole/go-ethereum/p2p/discv5"
	"github.com/novaknole/go-ethereum/p2p/enode"
	"github.com/novaknole/go-ethereum/p2p/nat"
...
func SetShhConfig(ctx *cli.Context, stack *node.Node) {
	if ctx.GlobalIsSet(WhisperEnabledFlag.Name) ||
		...
		log.Warn("Whisper support has been deprecated and the code has been moved to github.com/novaknole/whisper")
	}
}
...
func SetEthConfig(ctx *cli.Context, stack *node.Node, cfg *eth.Config) {
	...
	if cfg.RPCGasCap != 0 {
		log.Info("Set global gas cap nice", "cap", cfg.RPCGasCap)
	} else {
